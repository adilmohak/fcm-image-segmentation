...
class FCM_S1_Segmenter:
    def __init__(self, image, num_clusters=4, m=2, max_iter=100, threshold=1e-5):
        """
        Initializes the FCM_S1_Segmenter with the given parameters.
    ...
    def segment(self):
        ...
        # Apply the FCM_S1 algorithm
        cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(
            flattened.T, self.num_clusters, self.m, error=self.threshold, maxiter=self.max_iter, init=None)
...
if __name__ == "__main__":
    ...
    # Create an instance of the FCM_S1_Segmenter
    segmenter = FCM_S1_Segmenter(image, num_clusters=4, m=2, max_iter=100, threshold=1e-5)
